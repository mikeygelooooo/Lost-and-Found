        ...
        <div class="col-md-8">
            <div class="card shadow border-0">
                ...
                <div class="card-body px-4 py-4">
                    ...
                    <h5 class="mb-3 text-info fw-bold">
                        <i class="fas fa-bell me-2"></i>Notification Preferences
                    </h5>
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="checkbox" value="1" id="emailNotifications" name="email_notifications" checked>
                        <label class="form-check-label" for="emailNotifications">
                            Email Notifications
                        </label>
                    </div>
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="checkbox" value="1" id="smsNotifications" name="sms_notifications">
                        <label class="form-check-label" for="smsNotifications">
                            SMS Notifications
                        </label>
                    </div>
                    <div class="col-xl-4">
                        <button type="submit" class="btn btn-info p-2 w-100">
                            <i class="fas fa-floppy-disk me-1"></i> SAVE
                        </button>
                    </div>
