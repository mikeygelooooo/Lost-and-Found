        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-danger text-white">
                    <h3 class="mb-0">Report a Lost Item</h3>
                </div>
                <div class="card-body">
                    <form id="lostItemForm" method="post" action="<?= base_url('reports/create') ?>">
                        <input type="hidden" name="report-type" value="lost">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Optional: Upload a photo of your item to help with identification</div>
                        </div>

                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" name="notifyCheck">
                            <label class="form-check-label" for="notifyCheck">Notify me when a matching item is found</label>
                        </div>
